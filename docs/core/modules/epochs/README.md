...
```sh
gotabitd query epochs epoch-infos
```
::: details Example
...
```sh
gotabitd query epochs current-epoch [identifier]
```
...
```sh
gotabitd query epochs current-epoch day
```
...
This is modify by [osmosis epochs](https://github.com/osmosis-labs/osmosis/tree/main/x/epochs)
